    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 10, alignItems: "center", width: "100%" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, width: "100%" }}>
        <button onClick={onToggle} style={{
          ...
          background: active ? "#00cc55" : "#2a2a2a", cursor: "pointer",
          color: active ? "#000" : "#999", fontFamily: "monospace", fontSize: 10, fontWeight: "bold",
        ...
        <div style={{ color: active ? "#00ff66" : "#666", fontFamily: "monospace", fontSize: 20, fontWeight: "bold",
          width: 50, textAlign: "right", flexShrink: 0 }}>{value.toFixed(0)}%</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ background: "#111", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 16, gap: 12 }}>
      ...
      <div style={{ background: "#1a1a1a", padding: "16px 20px", borderRadius: 12, border: "1px solid #333", width: "100%", maxWidth: 480, display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        {/* Slider */}
        <Slider value={autoMode && a.state !== "idle" ? a.searchPower : power} onChange={handleKnobChange} onToggle={handleToggle} active={active} disabled={false} />
        ...
        {overrideNotice && (
          <div style={{ background: "#1a1a00", border: "1px solid #ff0", borderRadius: 8, padding: 10, fontFamily: "monospace", fontSize: 11, color: "#ff0", textAlign: "center" }}>
            Manual override — switched to manual mode. Slider input detected.
          </div>
        )}
